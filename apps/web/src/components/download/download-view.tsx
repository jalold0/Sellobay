...
// MUHIM: bu fayl ATAYLAB client komponent.
//
// Sahifa avval server komponent edi va lucide ikonkalarini (Smartphone, Apple,
// Monitor, Globe...) PlatformCard/FeatureItem ga PROP sifatida uzatardi. Ular esa
// 'use client' komponentlar. React komponenti — funksiya, funksiyani esa RSC
// chegarasidan o'tkazib bo'lmaydi: production'da sahifa
//   "Functions cannot be passed directly to Client Components"
// xatosi bilan 500 qaytarardi (dev'da bu xato chiqmasdi).
//
// Endi ikonka ham, uni ishlatuvchi komponent ham BITTA client chegarasi ichida —
// hech narsa serializatsiya qilinmaydi. page.tsx server bo'lib qoladi va faqat
// metadata beradi.
