          ...
          <AlertDescription>
            <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-start">
              <button
                ...
                className="group relative h-28 w-28 shrink-0 overflow-hidden rounded-lg border bg-muted"
                title="Kattalashtirish"
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={order.manualCard!.receipt} alt="chek" className="h-full w-full object-cover" />
