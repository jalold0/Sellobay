...
export async function GET(_req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const raw = (payment?.rawPayload ?? null) as { kind?: string; receipt?: string; note?: string | null } | null;
  ...
  return apiOk({
    ...
    shippingAddress: o.shippingAddress
      ? {
          ...
          city: o.shippingAddress.city,
          street: [o.shippingAddress.street, o.shippingAddress.building, o.shippingAddress.apartment]
            .filter(Boolean)
            .join(', '),
