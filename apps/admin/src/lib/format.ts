// Format helperlari — money/date/relative time. Markazlashtirilgan,
// chunki butun panel bo'ylab bir xil format kerak.
// Hammasi DETERMINISTIK — SSR (Node ICU) va CSR (brauzer ICU) farqlariga moyil emas.
...
// O'zbek tilida oy nomlari — qisqa va to'liq
...
// Deterministik nisbiy vaqt — Intl.RelativeTimeFormat o'rniga manuel
